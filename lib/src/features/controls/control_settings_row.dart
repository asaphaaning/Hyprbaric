                  ...
                  decoration: ShapeDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: state.pressed
                          ? const <Color>[Color(0xFF111216), Color(0xFF17181D)]
                          : state.hovered
                          ? const <Color>[Color(0xFF27282E), Color(0xFF1B1C21)]
                          : const <Color>[Color(0xFF1D1E23), Color(0xFF141519)],
                    ),
                    shadows: const <BoxShadow>[
                      BoxShadow(color: Color(0x1AFFFFFF), offset: Offset(0, 1)),
                      BoxShadow(
